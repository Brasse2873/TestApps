    ...
    <form id="form1" runat="server">
        <div id="pagecontainer">
            ...
            <div id="leftsidebar" class="column">
                ...
                <h3>Matters of the Web</h3>
                <p> Rightsidebar Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Curabitur in sem. Vivamus adipiscing vulputate lacus. Sed enim 
                lorem, fringilla eget, nonummy sed, ullamcorper sit amet, diam. Sed a justo. Curabitur quis nibh sit amet nunc malesuada 
                rutrum.</p>
            <div id="maincontent" class="column">
                ...
                tincidunt.</p>
                <asp:Image ID="Image1" runat="server" CssClass="floatright" 
                    ImageUrl="~/Chrysanthemum.jpg"/>
